...
// import { mockUser1 } from '@/auth/mocks';
...
describe('Login', () => {
  ...
  describe('Sign Password', () => {
    ...
    test('should do something', async () => {
      ...
      expect(jwt.sign).toHaveBeenCalledWith(payload, AUTH_JWT_SIGN_SECRET, { algorithm: 'HS256', expiresIn: '1d' });
    });
  });
  ...
  describe('200 OK', () => {
    test('should return token', async () => {
      ...
      expect(msg).toEqual('User Login Successfully');
